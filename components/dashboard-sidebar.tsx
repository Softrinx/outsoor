...
const NAV_TOOLS = [
  ...
  { icon: ShieldCheck,       label: "Security",      sub: "Auth & tokens",       href: "/dashboard/security",       color: "#ef4444" },
  { icon: SlidersHorizontal, label: "Settings",      sub: "Preferences",         href: "/dashboard/settings",       color: "#a1a1aa" },
]
