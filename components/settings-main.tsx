            ...
            <TabsContent value="profile" className="space-y-6">
              <Card className="bg-[#1A1B1F] border-[#2D2D32]">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <div className="w-20 h-20 bg-gradient-to-br from-[#8C5CF7] to-[#3B1F82] rounded-full flex items-center justify-center">
                        <span className="text-white font-semibold text-2xl">{user.name?.[0]?.toUpperCase() || 'U'}</span>
                      </div>
                  ...
                  <Button onClick={handleProfileUpdate} className="bg-[#8C5CF7] hover:bg-[#7C4CF7] text-white">
            ...
            <TabsContent value="security" className="space-y-6">
              <Card className="bg-[#1A1B1F] border-[#2D2D32]">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full border-[#2D2D32] text-[#A0A0A8] hover:bg-[#2D2D32] hover:text-white">
